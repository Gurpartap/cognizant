module Cognizant
  module System
    def self.exec(command, options = {})
      ...
      options[:groups]    ||= []
      options[:env]       ||= {}
      options[:daemonize] ||= false # TODO: Auto daemonize if required for default.
      ...
      fork_pid = ::Process.fork do
        ...
        # Merge spawn options.
      	spawn_options = self.construct_spawn_options({
      		:in  => stdin,
      		:out => stdout,
      		:err => stderr
      	})
    ...
    def self.construct_spawn_options(overrides = {})
      spawn_options = {}
